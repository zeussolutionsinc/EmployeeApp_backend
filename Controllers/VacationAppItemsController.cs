...
namespace VacationAppApi.Controllers
{
    ...
    {
        private readonly VacationAppContext _context;
        private readonly BlobServiceClient _blobServiceClient;
        private readonly string _containerName;

        public VacationAppItemsController(VacationAppContext context, IConfiguration configuration)
        {
            _context = context;
